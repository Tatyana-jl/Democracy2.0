    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="junstiontestApp.role.home.createOrEditLabel">
              <Translate contentKey="junstiontestApp.role.home.createOrEditLabel">Create or edit a Role</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : roleEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  <Label id="roleLabel" for="role-role">
                    <Translate contentKey="junstiontestApp.role.role">Role</Translate>
                  </Label>

...
export class Role extends React.Component<IRoleProps, IRoleState> {
  ...
  render() {
    ...
    return (
      <div>
        <h2 id="role-heading">
          <Translate contentKey="junstiontestApp.role.home.title">Roles</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="junstiontestApp.role.home.createLabel">Create a new Role</Translate>
          </Link>
        </h2>
        <div className="table-responsive">
          {roleList && roleList.length > 0 ? (
            <Table responsive aria-describedby="role-heading">
              <thead>
                <tr>
                  ...
                  <th className="hand" onClick={this.sort('role')}>
                    <Translate contentKey="junstiontestApp.role.role">Role</Translate> <FontAwesomeIcon icon="sort" />
                  </th>
                  <th />
                </tr>
              </thead>
            ...
            <div className="alert alert-warning">
              <Translate contentKey="junstiontestApp.role.home.notFound">No Roles found</Translate>
            </div>
          )}
        </div>

...
public class District implements Serializable {
    ...
    public District nameSk(String nameSk) {
        this.nameSk = nameSk;
        return this;
    }
    ...
    public District accountingEntities(Set<AccountingEntity> accountingEntities) {
        this.accountingEntities = accountingEntities;
        return this;
    }

    public District addAccountingEntity(AccountingEntity accountingEntity) {
        this.accountingEntities.add(accountingEntity);
        accountingEntity.setDistrict(this);
        return this;
    }

    public District removeAccountingEntity(AccountingEntity accountingEntity) {
        this.accountingEntities.remove(accountingEntity);
        accountingEntity.setDistrict(null);
        return this;
    }
